...
public class TileStorage : MonoBehaviour
{
    ...
    public static List<CustomTileData> customTileDataScripts = new List<CustomTileData>()
    {
         { null }, //TileTypes.standardTile
        { null }, //TileTypes.firstTestTile
        { null }, //TileTypes.secondTestTile
        { null }, //TileTypes.thirdTestTile
        { new ConveyerBeltData() }, //TileTypes.FourthTestTile
        { null }  //TileTypes.FifthTestTile
    };
